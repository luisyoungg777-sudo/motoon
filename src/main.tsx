...
/**
 * O Motoon inteiro mora no IndexedDB. Se ele não abrir — janela anônima de
...
function Bloqueado() {
  return (
    <div className="mx-auto flex min-h-screen max-w-conteudo flex-col justify-center gap-3 px-6">
      <h1 className="text-titulo font-bold">O Motoon não conseguiu abrir o armazenamento</h1>
      ...
      <p className="text-corpo text-textoSec">
        ...
        outra página. Abrir o Motoon numa aba normal resolve.
      </p>
    </div>
  )
}
